                        ...
                        <main id="pjax" class="fn__flex-1">
                            ...
                            <div class="nexmoe-post">
                                ...
                                <div class="nexmoe-post-meta">
                                    ...
                                    <#if article.articleCategory?? &&article.articleCategory !=""><span>
                                            <i class="nexomefont iconfont solo-category"></i>
                                        ...
                                        <#if articleTag_index==0>
                                            <#if articleCategory??><span>
                                                    <a class="nexmoefont iconfont solo-category -link"
                                                        href="${servePath}/category/${articleCategory.categoryURI}">
                                                        ${articleCategory.categoryTitle}
                                                    </a>
                                                </span>
                                            </#if>
                                        </#if><span><a class="nexmoefont iconfont solo-tag -link"
                                                href="${servePath}/tags/${articleTag?url('UTF-8')}">
                                                ${articleTag}
                                            </a></span>
                                    </#list>
                                </div>
