                            ...
                            <div class="post wrapper wrapper--miner">
                                ...
                                <div class="ft__fade item__meta">
                                    ...
                                    <#if article.articleCategory?? && article.articleCategory !="">
                                        in <a href="${servePath}/category/${article.categoryURI}">
                                    ...
                                    <#if interactive=="on">
                                        <#if article.articleCommentCount !=0>
                                            and <a href="#comments">
                                                ${article.articleCommentCount} comments</a>
                                        </#if>
                                    </#if>
                                </div>
                                ...
                                <div class="wrapper">
                                    <span class="post__share mobile__none">
                                        ...
                                        <span class="post__code tag tag--7"
                                            ...
                                            data-url="${isRss?then(article.articlePermalink, servePath + article.articlePermalink)}"
