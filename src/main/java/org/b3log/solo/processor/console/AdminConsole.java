...
public class AdminConsole {
  ...
  public void showAdminFunctions(final RequestContext context) {
    ...
    final String templateName =
        StringUtils.substringBetween(requestURI, Latkes.getContextPath() + '/', ".") + ".ftl";
    final AbstractFreeMarkerRenderer renderer = new ConsoleRenderer(context, templateName);
   ...
   */
  private void fireFreeMarkerActionEvent(
      final String hostTemplateName, final Map<String, Object> dataModel) {
