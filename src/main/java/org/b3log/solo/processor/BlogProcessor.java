...
public class BlogProcessor {
        ...
        if (faviconCache.containsKey(resolution)) {
          ...
          try {
            ...
            if (mediaFileType == null) {
              ...
              mediaFileType = new MediaFileUtil.MediaFileType(33, "image/png");
            }
   ...
   *
   * <ul>
   *   <li>Time of the recent updated article
   *   <li>Article count
   *   <li>Comment count
   *   <li>Tag count
   *   <li>Serve path
   *   <li>Static serve path
   *   <li>Solo version
   *   <li>Runtime mode
   *   <li>Runtime database
   *   <li>Locale
  ...
  public void getBlogInfo(final RequestContext context) {
    ...
    jsonObject.put(
        "articleCount", statistic.getLong(Option.ID_T_STATISTIC_PUBLISHED_ARTICLE_COUNT));
    jsonObject.put(
