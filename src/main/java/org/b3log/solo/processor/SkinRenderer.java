...
public final class SkinRenderer extends AbstractFreeMarkerRenderer {
  ...
  protected Template getTemplate() {
    ...
    if (null == ret) {
      ...
      try {
        LOGGER.log(
            Level.INFO,
            "It seems like we can't found the skin for mobile. Restoring this setting default, please refresh your page, it should be OK.");
  ...
  /**
   * Processes the specified FreeMarker template with the specified request, data model, pjax
   * hacking.
   *
