...
public class DataModelService {
  ...
  public void fillIndexArticles(
    ...
    try {
      ...
      List<JSONObject> articles =
          CollectionUtils.jsonArrayToList(articlesResult.optJSONArray(Keys.RESULTS));
      articles.forEach(article -> article.put("isRss", false));
      final int pageCount =
          articlesResult
              .optJSONObject(Pagination.PAGINATION)
  ...
  public void fillLinks(final Map<String, Object> dataModel) throws ServiceException {
    ...
    try {
      ...
      final Query query =
          new Query().addSort(Link.LINK_ORDER, SortDirection.ASCENDING).setPageCount(1);
  ...
  public void fillFollows(final Map<String, Object> dataModel) throws ServiceException {
    ...
    try {
      ...
      final Query query =
          new Query().addSort(Follow.FOLLOW_ORDER, SortDirection.ASCENDING).setPageCount(1);
  ...
  public void fillCategories(final Map<String, Object> dataModel) throws ServiceException {
    ...
    try {
      ...
      final List<JSONObject> categories =
          categoryRepository.getMostUsedCategories(Integer.MAX_VALUE);
   ...
   * @throws ServiceException service exception
   */
  public void fillMostUsedCategories(
    ...
    try {
      ...
      final List<JSONObject> categories =
          categoryRepository.getMostUsedCategories(mostUsedCategoryDisplayCnt);
        ...
        if (1 < archiveDates.size()) { // XXX: Workaround, remove the duplicated archive dates
          for (int i = 1; i < maxArchiveResult; i++) {
            ...
            final String lastDateString =
                DateFormatUtils.format(last.getLong(ArchiveDate.ARCHIVE_TIME), "yyyy/MM");
   ...
   * @throws ServiceException service exception
   */
  public void fillMostViewCountArticles(
      final Map<String, Object> dataModel, final JSONObject preference) throws ServiceException {
    ...
    try {
      ...
      final int mostCommentArticleDisplayCnt =
          preference.getInt(Option.ID_C_MOST_VIEW_ARTICLE_DISPLAY_CNT);
      final List<JSONObject> mostViewCountArticles =
          articleRepository.getMostViewCountArticles(mostCommentArticleDisplayCnt);
   ...
   * @throws ServiceException service exception
   */
  public void fillMostCommentArticles(
      final Map<String, Object> dataModel, final JSONObject preference) throws ServiceException {
    ...
    try {
      ...
      final int mostCommentArticleDisplayCnt =
          preference.getInt(Option.ID_C_MOST_COMMENT_ARTICLE_DISPLAY_CNT);
      final List<JSONObject> mostCommentArticles =
          articleRepository.getMostCommentArticles(mostCommentArticleDisplayCnt);
    ...
    try {
      ...
      Collections.sort(
          ...
          Comparator.comparingInt(
              o -> Integer.parseInt(o.optString(Tag.TAG_T_PUBLISHED_REFERENCE_COUNT))));
    ...
    try {
      ...
      final Query query =
          new Query()
              .setPageCount(1)
              .setFilter(
                  new PropertyFilter(User.USER_ROLE, FilterOperator.NOT_EQUAL, Role.VISITOR_ROLE));
  ...
  /**
   * Sets some extra properties into the specified article with the specified preference, performs
   * content and abstract editor processing.
   *
   ...
   */
  private void setArticleExProperties(
      final RequestContext context, final JSONObject article, final JSONObject preference)
      throws ServiceException {
    try {
   ...
   *
   * <p>The batch version of method {@linkplain #setArticleExProperties(RequestContext, JSONObject,
   * JSONObject)}.
   *
   * <p>Article ext properties:
   *
   ...
   * @throws ServiceException service exception
   */
  public void setArticlesExProperties(
      final RequestContext context, final List<JSONObject> articles, final JSONObject preference)
      throws ServiceException {
   ...
   *
   * <ul>
   *   <li>If the abstract is {@code null}, sets it with ""
   *   <li>If user configured preference "titleOnly", sets the abstract with ""
   *   <li>If user configured preference "titleAndContent", sets the abstract with the content of
   *       the article
   * </ul>
   *
   * @param preference the specified preference
  ...
  public String getTopBarHTML(final RequestContext context) throws ServiceException {
    ...
    try {
      ...
      topBarModel.put(
          Common.IS_ADMIN, Role.ADMIN_ROLE.equals(currentUser.getString(User.USER_ROLE)));
      topBarModel.put(
          Common.IS_VISITOR, Role.VISITOR_ROLE.equals(currentUser.getString(User.USER_ROLE)));
