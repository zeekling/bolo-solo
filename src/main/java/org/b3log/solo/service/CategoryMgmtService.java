...
public class CategoryMgmtService {
  ...
  /**
   * Changes the order of a category specified by the given category id with the specified
   * direction.
   *
  ...
  public void changeOrder(final String categoryId, final String direction) throws ServiceException {
    ...
    try {
      ...
      if (null == targetCategory) {
        ...
        LOGGER.log(
            Level.WARN,
            "Cant not find the target category of source category [order={0}]",
            srcCategoryOrder);
   ...
   */
  @Transactional
  public void removeCategoryTag(final String categoryId, final String tagId)
              ...
              .setFilter(
                  CompositeFilterOperator.and(
                      new PropertyFilter(
                          ...
                          categoryId),
                      new PropertyFilter(
                          Tag.TAG + "_" + Keys.OBJECT_ID, FilterOperator.EQUAL, tagId)));
   ...
   */
  @Transactional
  public void updateCategory(final String categoryId, final JSONObject category)
      throws ServiceException {
    try {
