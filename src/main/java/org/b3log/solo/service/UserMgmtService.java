...
public class UserMgmtService {
  ...
  public void refreshUSite() {
    ...
    try {
      ...
      final HttpResponse res =
          HttpRequest.post("https://" + Global.HACPAI_DOMAIN + "/user/usite")
   ...
   *
   * @param requestJSONObject the specified request json object, for example, "oId": "", "userName":
   *     "", "userRole": "", "userURL": "", "userB3Key": "", "userGitHubId": "" // optional
   * @throws ServiceException service exception
   */
  public void updateUser(final JSONObject requestJSONObject, boolean changePassword)
   ...
   *     "userURL": "", // optional, uses 'servePath' instead if not specified "userRole": "", //
   *     optional, uses {@value Role#DEFAULT_ROLE} instead if not specified "userAvatar": "", //
   *     optional, users generated gravatar url instead if not specified "userGitHubId": "",
   *     "userB3Key": ""
