...
public final class Images {
  ...
  public static String qiniuImgProcessing(final String html) {
    ...
    for (final String imgSrc : imgSrcs) {
      if (StringUtils.contains(imgSrc, ".gif")
      ...
      ret =
          StringUtils.replace(
              ret, imgSrc, imgSrc + "?imageView2/2/w/1280/format/jpg/interlace/1/q/100");
    }
  ...
  public static File compressImage(File inputFile, float quality) throws IOException {
    ...
    LOGGER.log(
        Level.INFO, "Temp Image " + inputFile.getName() + " Delete [" + inputFile.delete() + "]");
