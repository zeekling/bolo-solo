...
public final class Skins {
  ...
  /**
   * Fills the specified data model with the current skin's
   * (WebRoot/skins/${skinDirName}/lang/lang_xx_XX.properties) and core language
   ...
   */
  public static void fillLangs(
      final String localeString, String currentSkinDirName, final Map<String, Object> dataModel)
  ...
  /**
   * Gets all skin directory names. Scans the /skins/ directory, using the subdirectory of it as the
   * skin directory name, for example,
   *
   * <pre>
   * ${Web root}/skins/
   *     <b>default</b>/
  ...
  /**
   * Gets skin directory name from the specified request. Refers to <a
   * href="https://github.com/b3log/solo/issues/12060">前台皮肤切换</a> for more details.
   *
   * @param context the specified request context
