...
public class MailService {
   ...
   * @param commentEmail
   */
  public static void addCommentMailContext(
      String commentId, String commentUser, String commentEmail) {
    ...
    bind.append(commentId).append(":").append(commentUser).append(":").append(commentEmail);
    // Write
    try {
    ...
    LOGGER.log(
        Level.INFO,
        "Generate user comment context [commentId: "
            + commentId
            + ", commentUser: "
            + commentUser
            + ", email: "
  ...
  public static void loadMailSettings() {
    try {
      ...
      String mailUsername =
          optionRepository.get(Option.ID_C_MAIL_USERNAME).optString(Option.OPTION_VALUE);
      String mailPassword =
          optionRepository.get(Option.ID_C_MAIL_PASSWORD).optString(Option.OPTION_VALUE);
      if (!mailBox.isEmpty()) {
