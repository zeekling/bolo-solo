...
public final class Option {
  ...
  public static final String ID_C_MOST_COMMENT_ARTICLE_DISPLAY_CNT =
  ...
  public static final String ID_C_ARTICLE_LIST_PAGINATION_WINDOW_SIZE =
  ...
  public static final String ID_T_STATISTIC_PUBLISHED_ARTICLE_COUNT =
      "statisticPublishedBlogArticleCount";

  /** Key of statistic blog comment(published article) count. */
  public static final String ID_T_STATISTIC_PUBLISHED_BLOG_COMMENT_COUNT =
  ...
  public static final String ID_C_ENABLE_AUTO_FLUSH_BLOG_TO_GITHUB_PROFILE =
      "enableAutoFlushGitHubProfile";
  ...
  public static final class DefaultPreference {
    ...
    public static final String DEFAULT_FAVICON_URL =
        "https://pic.stackoverflow.wiki/uploadImages/114/246/231/87/2020/06/06/16/41/3e4a3ce8-8882-4258-9860-a337bf859605.png";
