  ...
  public static void perform() throws Exception {
    ...
    try {
      ...
      final String checkSql =
          "SELECT count(*) AS C FROM information_schema.COLUMNS WHERE table_name = ? AND column_name = 'userPassword'";
      final PreparedStatement ps = connection.prepareStatement(checkSql);
      ps.setString(1, tablePrefix + "user");
